...
angular.module('anyNoteCli', ['ngAnimate', 'ngCookies', 'ngTouch', 'ngSanitize', 'ngMessages', 'ngAria', 'ngResource', 'ui.router', 'ui.bootstrap', 'ui.codemirror', 'ng-sortable', 'satellizer', 'ngStorage', 'decipher.tags'])
    .config(config)
    .config(routerConfig)
    .run(runBlock)
